...
int main()
{
    ...
    for (int i = 0; i < ITERATIONS; i++)
    {
        ...
        globalArray[i % ARRAY_SIZE] += (hot_data.c | 0x1) + local1;
        ...
        if (i % 100 == 0)
        {
            ...
            globalArray[i % ARRAY_SIZE] += (mid_vars.z >> 1) + hot_data.a;
            local3 = globalArray[0];
        }

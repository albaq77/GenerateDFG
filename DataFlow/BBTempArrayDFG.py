    ...
    for func_name, bb_num, code_text in bb_blocks:
        ...
        for line in code_text.split('\n'):
            ...
            if var_match:
                ...
                base_type, reg_name, var = pattern_tool(var, line.startswith('store '))
                if not base_type:
                    continue
                        ...
                        while queue and var_temp_flag:
                            ...
                            if temp_var_match:
                                ...
                                if int(split_tool(array_var_name, '%')) <= max_temp:
                                    temp_base_type, reg_name, var = pattern_tool(current_value, current_value.startswith('store '))
...
def main():
    ...
    try:
        file_path = '/mnt/hgfs/graduate/codeProgram/HUAWEIProject/DFG-NewGraph-Changer-main/BBDyAnalysis/input/parseccanneal/'
